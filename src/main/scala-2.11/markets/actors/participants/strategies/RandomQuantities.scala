...
trait RandomQuantities {
  ...
  /** Generates a randomly chosen quantity for an order to sell some tradable.
    *
  ...
  /** Generates a randomly chosen quantity for an order to buy some tradable.
    *
    * @param ticker   an [[akka.agent.Agent `Agent`]] storing the current market price of the
    *                 `tradable`.
    * @param tradable some [[markets.tradables.Tradable `Tradable`]] object.
