...
/** Trait implementing an `GenericImmutableOrderBook` using a TreeSet.
  *
  ...
  *        order book.
  */
trait GenericImmutableTreeSetOrderBook[A <: Order] extends GenericImmutableOrderBook[A, TreeSet[A]] {
