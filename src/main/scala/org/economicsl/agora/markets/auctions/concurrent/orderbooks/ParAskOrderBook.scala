...
class ParAskOrderBook[A <: AskOrder with Persistent](tradable: Tradable) extends GenOrderBook[A]{
...
object ParAskOrderBook {

  def apply[A <: AskOrder with Persistent](tradable: Tradable): ParAskOrderBook[A] = {
    new ParAskOrderBook(tradable)
  }
