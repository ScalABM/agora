...
class PostedPriceAuctionSpec extends FlatSpec with Matchers {
  ...
  "Average price of a Fill generated by a auctions.mutable.continuous.PostedPriceAuction" should "be (close to!) 100" in {
