...
/** Class implementing a functional test of a continuous, two-sided posted price auction.
  ...
  */
class TwoSidedPostedPriceAuctionSpec extends FlatSpec with Matchers {
  ...
  /** Define an instance of a `TwoSidedPostedPriceAuction`.
    *
    * User needs only to define the `AskOrderBook`, `BidOrderBook`, and the rules used for matching and
    * price formation. The mechanics of the auction itself are already defined.
    */
  val auction = {
