...
class BuyersBidDoubleAuctionSpec extends FlatSpec with Matchers {
  ...
  val auction = new BuyersBidDoubleAuction(tradable)

  "Average price of a Fill generated by a continuous.BuyersBidDoubleAuction" should "be roughly 75" in {
    ...
    val minBidPrice = orderGenerator.bidPriceDistribution.getSupportLowerBound
    val maxBidPrice = orderGenerator.bidPriceDistribution.getSupportUpperBound
    val expectedFillPrice = 0.5 * (minBidPrice + maxBidPrice)
