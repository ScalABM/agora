...
class DoubleAuctionSpec extends FlatSpec with Matchers {
  ...
  /** Define an instance of a `ContinuousDoubleAuction`.
    *
    * User needs only to define the rules used for price formation (since price formation determines trading incentives)
    */
  val auction = {
  ...
  "Average price of a Fill generated by a continuous.TwoSidedPostedPriceAuction" should "be (close to!) 100" in {
