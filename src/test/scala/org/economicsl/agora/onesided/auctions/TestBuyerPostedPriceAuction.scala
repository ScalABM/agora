...
import org.economicsl.agora.onesided.auctions.mutable.BuyerPostedPriceAuction
import org.economicsl.agora.onesided.matching.FindBestPricedMatch
...
case class TestBuyerPostedPriceAuction(tradable: Tradable)(implicit ordering: Ordering[LimitBidOrder])
  ...
  val matchingFunction = new FindBestPricedMatch[LimitAskOrder, LimitBidOrder]()
