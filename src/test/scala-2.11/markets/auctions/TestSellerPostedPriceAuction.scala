...
class TestSellerPostedPriceAuction(val matchingFunction: MatchingFunction[AskOrder, BidOrder],
  ...
  protected[auctions] val orderBook = orderbooks.mutable.OrderBook[AskOrder](tradable)
