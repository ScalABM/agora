...
import markets.matching.MyMatchingFunction
...
object ContinuousDoubleAuctionMicroBenchmark extends Bench.OnlineRegressionReport {
  ...
  val buyerMatchingFunction = new MyMatchingFunction[LimitBidOrder, LimitAskOrder]

  val sellerPricingFunction = new AveragePricingFunction[LimitAskOrder, LimitBidOrder](0.5)
  val sellerMatchingFunction = new MyMatchingFunction[LimitAskOrder, LimitBidOrder]
